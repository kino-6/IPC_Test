...
public class PipeClient
{
	...
	private static string RequestFilePath = @"textfile.txt";
	private static string currentProcessName = @"Client.exe";
		...
		if (args.Length > 0)
		{
			if (args[0] == "spawnclient")
			{
				...
				if (ss.ReadString() == "I am the one true server!")
				{
					...
					// by the server.
					ss.WriteString(RequestFilePath);
	...
	private static void StartClients()
	{
		...
		Console.WriteLine("Spawning client processes... {0}\n", currentProcessName);
